				...
				<div class="col-md-2">
					<div class="span">
						<ul class="nav nav-list">
							...
							<li class="active">
								<a href="<?php echo $base_url;?>/user/information">我的资料</a>
							</li>
							<li>
								<a href="<?php echo $base_url;?>/user/collection?page=1" style="color:white;background:#0000aa">我的收藏</a>
							</li>
							<li>
